...
const Card = ({ name, type, abundance, role }: Microbe) => {
  return (
    <div className="relative flex flex-col items-center p-6 overflow-hidden border border-black/5 card-hover group md:p-8">
      <div className="flex flex-col items-center w-full h-full space-y-4 text-center">
        <CardHeader type={type} role={role} />

        <div className="space-y-2">
          <h3 className="text-xl font-bold tracking-tight text-secondary md:text-2xl">{name}</h3>
